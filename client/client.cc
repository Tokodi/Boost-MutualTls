...
void client::initializeTls() try {
    ...
    _sslContext.set_verify_callback(std::bind(&client::certVerifyCB, this, std::placeholders::_1, std::placeholders::_2), error);
    if (error) {
...
bool client::certVerifyCB(bool preverified, boost::asio::ssl::verify_context& ctx) {
